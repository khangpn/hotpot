...
\newcommand{\myDegree}{MDP in Information Security and Crypt. (Tech.)\xspace}
\newcommand{\myName}{Ph\'{u}c-Khang Nguy\~{\^{e}}n\xspace}
\newcommand{\myProf}{Paavo Nevalainen\xspace}
\newcommand{\myOtherProf}{Tapio Pahikkala\xspace}
\newcommand{\mySupervisor}{Paavo Nevalainen\xspace}
...
\linespread{1.2} % a bit more for Palatino % NOTE: line spacing adjustment, uncomment this when combine to send to supervisor for commenting easily
