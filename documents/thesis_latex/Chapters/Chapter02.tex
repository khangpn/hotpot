...
In every organizations, there is very likely a central system where everyone with different roles can login and access data flowing in it.
...
Let us call $S1$ subject's security level, and $S2$ is object's, where 
